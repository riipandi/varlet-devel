...
namespace VarletCli
{
    ...
    {
        private IList<object> Columns { get; set; }
        private IList<object[]> Rows { get; set; }

        private ConsoleTableOptions Options { get; set; }
        ...
        private ConsoleTable AddColumn(IEnumerable<string> names)
        {
        ...
        public void Write(Format format = VarletCli.Format.Default)
        {
            switch (format)
            {
                case VarletCli.Format.Default:
                    Console.WriteLine(ToString());
                    break;
                case VarletCli.Format.MarkDown:
                    Console.WriteLine(ToMarkDownString());
                    break;
                case VarletCli.Format.Alternative:
                    Console.WriteLine(ToStringAlternative());
                    break;
                case VarletCli.Format.Minimal:
